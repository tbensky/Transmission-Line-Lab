...
To prepare for data analysis, linearize your equation for $C$, so the slope of a linear fit can be used to find $C$. (See https://github.com/tbensky/Transmission-Line-Lab/blob/main/transline.pdf for hints/help with this.)
